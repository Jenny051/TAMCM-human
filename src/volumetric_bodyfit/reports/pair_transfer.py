...
from volumetric_bodyfit.config.runtime import challenge_pair_file
...
@hydra.main(config_path=str(PROJECT_ROOT / "profiles"), config_name="default_match")
